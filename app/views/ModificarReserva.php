...
<body>
    <div id="mainContent">
        <div class="upper">
            <a href="<?php echo URLROOT; ?>/VerReserva/ver/<?php echo $restData['id'] ?>"><i class="fa-solid fa-arrow-left left-arrow"></i></a>
        ...
        <div id="reservaForm">
            <form id="reservar" action="<?php echo URLROOT; ?>/ModificarReserva/modificar/<?php echo $restData['reserva_id'] ?>" method="POST">
                <!-- Fecha -->
        ...
        <div class="botones">
            <?php
                ...
                if (!empty($data['response'])) {
                    echo "<button type='submit' form='reservar' class='btn btn-primary btn-reservar' disabled>Modificar</button>";
                } else {
                    echo "<button type='submit' form='reservar' class='btn btn-primary btn-reservar'>Modificar</button>";
                }
            ?>
        </div>
