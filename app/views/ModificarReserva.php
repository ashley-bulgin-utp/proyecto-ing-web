        ...
        <div id="reservaForm" method="post">
            <form action="">
                ...
                <div class="field-group">
                    ...
                    <input type="date" name="date" id="dateInput" value="<?php echo $reservaData['dia'] ?>" required>
                </div>
                <!-- Sillas de bebe -->
                <div class="field-group">
                ...
                <div class="field-group-textarea">
                    ...
                    <textarea name="comentario" id="comentario" placeholder="<?php echo($reservaData['comentarios']) ?>" ></textarea>
                </div>
                <div class="field-group">
